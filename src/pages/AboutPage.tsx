            ...
            <section className="px-8 max-w-6xl mx-auto mb-20">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
                    <div>
                        ...
                        <p className="text-white/60 leading-loose mb-6">
                        ...
                        <div className="flex gap-12 mt-10">
                            ...
                            <div>
                                ...
                                <p className="text-xs uppercase tracking-[3px] text-white/40 mt-1">Satisfaction</p>
                            </div>
                        </div>
                    </div>
                    <div className="aspect-[4/5] rounded-sm overflow-hidden bg-white/5">
                        <img src="https://images.unsplash.com/photo-1497366216548-37526070297c?q=80&w=800&auto=format&fit=crop"
                            alt="Studio" className="w-full h-full object-cover opacity-80 hover:opacity-100 transition-opacity duration-500" />
                    </div>
                </div>
            </section>

            <section className="bg-white/5 text-white py-24 px-8 rounded-sm mx-4 md:mx-8">
                <div className="max-w-6xl mx-auto text-center">
                    <h2 className="font-display text-3xl font-bold mb-4 text-gold/90">Designing Spaces, Defining Lives.</h2>
